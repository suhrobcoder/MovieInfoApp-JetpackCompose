...
class ViewModelFactory(private val repository: MovieRepository, private val favoritesRepository: FavoritesRepository? = null, private val id: Int? = null) :
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(HomeViewModel::class.java)) {
            ...
            return DetailsViewModel(repository, favoritesRepository!!, id!!) as T
        } else {
